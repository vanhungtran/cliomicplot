...
| | | |
|:---:|:---:|:---:|
| **Grouped scatter** | **Boxplot** | **Volcano** |
| [![scatter](man/figures/scatter.png)](man/figures/scatter.png) | [![boxplot](man/figures/boxplot.png)](man/figures/boxplot.png) | [![volcano](man/figures/volcano.png)](man/figures/volcano.png) |
| **MA plot** | **Kaplan-Meier** | **Heatmap** |
| [![MA](man/figures/ma.png)](man/figures/ma.png) | [![KM](man/figures/km.png)](man/figures/km.png) | [![heatmap](man/figures/heatmap.png)](man/figures/heatmap.png) |
| **PCA** | **Forest** | **Waterfall** |
| [![PCA](man/figures/pca.png)](man/figures/pca.png) | [![Forest](man/figures/forest.png)](man/figures/forest.png) | [![Waterfall](man/figures/waterfall.png)](man/figures/waterfall.png) |
| **Swimmer** | **Correlation** | **Text labels** |
| [![Swimmer](man/figures/swimmer.png)](man/figures/swimmer.png) | [![Correlation](man/figures/correlation.png)](man/figures/correlation.png) | [![text](man/figures/text.png)](man/figures/text.png) |

### Statistical & Distribution

| | | |
|:---:|:---:|:---:|
| **Violin** | **Density** | **Histogram** |
| [![Violin](man/figures/violin.png)](man/figures/violin.png) | [![Density](man/figures/density.png)](man/figures/density.png) | [![Histogram](man/figures/histogram.png)](man/figures/histogram.png) |
| **Ridge** | **Jitter** | **Beeswarm** |
| [![Ridge](man/figures/ridge.png)](man/figures/ridge.png) | [![Jitter](man/figures/jitter.png)](man/figures/jitter.png) | [![Beeswarm](man/figures/beeswarm.png)](man/figures/beeswarm.png) |
| **Barplot** | **Spineplot** | **Errorbar** |
| [![Barplot](man/figures/barplot.png)](man/figures/barplot.png) | [![Spineplot](man/figures/spineplot.png)](man/figures/spineplot.png) | [![Errorbar](man/figures/errorbar.png)](man/figures/errorbar.png) |
...
|:---:|:---:|:---:|
| **Lines** | **LM** | **LOESS** |
| [![Lines](man/figures/lines.png)](man/figures/lines.png) | [![LM](man/figures/lm.png)](man/figures/lm.png) | [![LOESS](man/figures/loess.png)](man/figures/loess.png) |
| **Ribbon** | **Bubble** | **Rug+Abline** |
| [![Ribbon](man/figures/ribbon.png)](man/figures/ribbon.png) | [![Bubble](man/figures/bubble.png)](man/figures/bubble.png) | [![Rug](man/figures/abline.png)](man/figures/abline.png) |

### Premier — Standout Visuals

| | | |
|:---:|:---:|:---:|
| **Raincloud** | **Dumbbell** | **Lollipop** |
| [![Raincloud](man/figures/raincloud.png)](man/figures/raincloud.png) | [![Dumbbell](man/figures/dumbbell.png)](man/figures/dumbbell.png) | [![Lollipop](man/figures/lollipop.png)](man/figures/lollipop.png) |
| **Radar** | **Waffle** | **Q-Q Plot** |
| [![Radar](man/figures/radar.png)](man/figures/radar.png) | [![Waffle](man/figures/waffle.png)](man/figures/waffle.png) | [![QQ](man/figures/qq.png)](man/figures/qq.png) |
...
| **Parallel coords** | **Spine** | **Rug** |
| [![Parallel](man/figures/parallel.png)](man/figures/parallel.png) | [![Spine](man/figures/spineplot.png)](man/figures/spineplot.png) | [![Rug](man/figures/rug.png)](man/figures/rug.png) |
...
<details><summary><b>📋 Click for Premier type code examples</b></summary>
...
db <- data.frame(country = c("USA","China","Japan","Germany","UK"),
                 before = c(80, 70, 78, 75, 72), after = c(85, 75, 80, 78, 76))
cliplot(after ~ country, data = db, type = "dumbbell")

# Lollipop — stylish ranking
cliplot(value ~ item, data = ll_df, type = "lollipop")

# Beeswarm — full distribution shape
cliplot(Sepal.Length ~ Species, data = iris, type = "beeswarm")

# Radar — multivariate profile comparison
radar_df <- data.frame(Group = c("Drug A","Drug B","Placebo"),
                        Efficacy = c(85,72,15), Safety = c(70,90,95),
                        Tolerability = c(75,80,60), Cost = c(60,45,85))
cliplot(radar_df, type = "radar")

# Alluvial/Sankey — flow diagram
cliplot(patient_flows, type = "alluvial", palette = "jco")

# Waffle — intuitive proportions
wf_df <- data.frame(Category = c("CR","PR","SD","PD"), Count = c(7,30,36,27))
cliplot(Count ~ Category, data = wf_df, type = "waffle")
```
</details>
...
<details><summary><b>📋 Click for R Graph Gallery code examples</b></summary>

```r
# Chord diagram — stunning circular flow
chord_mat <- matrix(sample(10:100, 25), 5)
rownames(chord_mat) <- LETTERS[1:5]; colnames(chord_mat) <- LETTERS[1:5]
cliplot(chord_mat, type = "chord", palette = "jco")

# Treemap — hierarchical proportions
tm_df <- data.frame(category = c("CDS","UTR","Intron","Intergenic","Promoter"),
                     bases = c(1500000, 800000, 2500000, 3200000, 200000))
cliplot(bases ~ category, data = tm_df, type = "treemap")

# Streamgraph — flowing time series
sg_df <- data.frame(time = rep(1:20, 3),
                     category = rep(c("CD8+","CD4+","NK"), each = 20),
...
path_df <- data.frame(time = 1:30, x = cumsum(rnorm(30)), y = cumsum(rnorm(30)))
cliplot(y ~ x, data = path_df, type = "connected")

# Circular barplot — dramatic ranking
cb_df <- data.frame(label = LETTERS[1:8], value = c(45,72,33,58,91,27,63,39))
cliplot(value ~ label, data = cb_df, type = "circular_bar")

# 2D Density contour — elegant scatter alternative
cliplot(y ~ x, data = data.frame(x = rnorm(500), y = rnorm(500)),
        type = "density2d", bins = 12)

# Parallel coordinates — multivariate exploration
pc_df <- data.frame(Group = sample(c("R","NR"), 30, TRUE),
                     CD4 = rnorm(30, 500, 150), CD8 = rnorm(30, 300, 100),
                     NK = rnorm(30, 100, 40), Bcell = rnorm(30, 200, 80))
cliplot(pc_df, type = "parallel")

# Dendrogram — hierarchical clustering
mat <- matrix(rnorm(50), nrow = 10)
rownames(mat) <- paste0("Gene", 1:10)
cliplot(mat, type = "dendrogram")

# Interactive mode — zoom, pan, hover (requires plotly)
p <- cliplot(mpg ~ wt | cyl, data = mtcars, type = "points")
cliplot_interactive(p)
```
</details>
